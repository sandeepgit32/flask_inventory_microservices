...
class TransactionModel(db.Model):
    ...
    @classmethod
    def filter_by_supplier(cls, supplier_name: str) -> List["WarehouseModel"]:
        return cls.query.filter_by(supplier_name=supplier_name)

    @classmethod
    def filter_by_product(cls, product_code: str) -> List["WarehouseModel"]:
        return cls.query.filter_by(product_code=product_code)

    @classmethod
    def filter_by_product_and_supplier(cls, product_code: str, supplier_name: str) -> List["WarehouseModel"]:
